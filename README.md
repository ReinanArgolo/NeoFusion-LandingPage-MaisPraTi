...
## Atualizações
- Bootstrap;
- Adiçao de CRUD, onde você pode se inscrever em eventos pré-estabelecidos;
- Requisição de JSONs para popular os cards e a seção "Nossos Serviços"
- tratamento de erro Fetch
- Adição de botão no Header para visualizar os eventos
